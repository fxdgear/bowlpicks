...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.timezome'
        db.add_column('core_game', 'timezome', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.timezome'
        db.delete_column('core_game', 'timezome')
