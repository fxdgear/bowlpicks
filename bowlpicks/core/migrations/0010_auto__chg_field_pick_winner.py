...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_pick', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Team'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Pick.winner'
        db.alter_column('core_pick', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Team']))
