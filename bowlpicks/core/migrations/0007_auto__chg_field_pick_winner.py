...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pick.winner'
        db.alter_column('core_pick', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Team']))


    def backwards(self, orm):
        
        # Changing field 'Pick.winner'
        db.alter_column('core_pick', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School']))
