...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.require_tie_breaker'
        db.add_column('core_game', 'require_tie_breaker', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Pick.is_tie_breaker'
        db.delete_column('core_pick', 'is_tie_breaker')


    def backwards(self, orm):
        
        # Deleting field 'Game.require_tie_breaker'
        db.delete_column('core_game', 'require_tie_breaker')

        # Adding field 'Pick.is_tie_breaker'
        db.add_column('core_pick', 'is_tie_breaker', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'core.game': {
            ...
            'away_team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'away_team'", 'to': "orm['core.Team']"}),
            ...
            'home_team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'home_team'", 'to': "orm['core.Team']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'core.pick': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Team']"})
        },
        'core.school': {
