...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_game', 'home_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Team']))

        # Changing field 'Game.away_team'
        db.alter_column('core_game', 'away_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Team']))


    def backwards(self, orm):
        
        # Changing field 'Game.home_team'
        db.alter_column('core_game', 'home_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School']))

        # Changing field 'Game.away_team'
        db.alter_column('core_game', 'away_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School']))
