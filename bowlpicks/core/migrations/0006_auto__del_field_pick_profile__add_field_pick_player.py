...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Pick.profile'
        db.delete_column('core_pick', 'profile_id')

        # Adding field 'Pick.player'
        db.add_column('core_pick', 'player', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Player']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Pick.profile'
        db.add_column('core_pick', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Player']), keep_default=False)

        # Deleting field 'Pick.player'
        db.delete_column('core_pick', 'player_id')
