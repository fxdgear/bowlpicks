...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pick.profile'
        db.alter_column('core_pick', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Player']))


    def backwards(self, orm):
        
        # Changing field 'Pick.profile'
        db.alter_column('core_pick', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile']))
    ...
    models = {
        ...
        'core.pick': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.Player']"}),
