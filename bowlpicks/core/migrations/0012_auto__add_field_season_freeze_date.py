...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Season.freeze_date'
        db.add_column('core_season', 'freeze_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Season.freeze_date'
        db.delete_column('core_season', 'freeze_date')
