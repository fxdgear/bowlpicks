...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.record'
        db.alter_column('core_team', 'record', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Team.record'
        raise RuntimeError("Cannot reverse this migration. 'Team.record' and its values cannot be restored.")
    ...
    models = {
        ...
        'core.team': {
            ...
            'record': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
