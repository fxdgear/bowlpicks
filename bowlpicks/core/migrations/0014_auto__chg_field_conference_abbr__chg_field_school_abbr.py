...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conference.abbr'
        db.alter_column('core_conference', 'abbr', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'School.abbr'
        db.alter_column('core_school', 'abbr', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Conference.abbr'
        db.alter_column('core_conference', 'abbr', self.gf('django.db.models.fields.CharField')(max_length=550))

        # Changing field 'School.abbr'
        db.alter_column('core_school', 'abbr', self.gf('django.db.models.fields.CharField')(max_length=10))
